            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
                ...
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Xeone - Anti Ban")
                    await guild.unban(user=user, reason="Xeone - Auto Recovery")                    
    ...
    async def on_member_join(self, member: discord.Member) -> None:
        ...
        async for entry in guild.audit_logs(
            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
                return
            if member.bot:
                await member.ban(reason="Xeone - Anti Bot")
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Xeone - Anti Bot")
        ...
        async for entry in guild.audit_logs(
            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
               ...
               # await channel.delete()
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Xeone - Anti Channel Create")
                await channel.delete()
    ...
    async def on_guild_channel_delete(self, channel) -> None:
        ...
        async for entry in guild.audit_logs(
            ...
            if entry.user.id in IGNORE or entry.user.id == guild.owner.id or entry.user.top_role >= guild.me.top_role:
                ...
                await guild.ban(entry.user,
                               reason="Xeone - Anti Channel Delete")
                await channel.clone()
    @commands.Cog.listener()
    async def on_guild_channel_update(
        ...
        async for entry in guild.audit_logs(
            ...
            #    await after.edit(name=f"{name}", reason=f"Xeone - Recovery")
                if guild.me.guild_permissions.ban_members:
                    await guild.ban(entry.user,
                                   reason="Xeone - Anti Channel Update")
                await after.edit(name=f"{name}", reason=f"Xeone - Recovery")
        ...
        async for entry in guild.audit_logs(
          ...
          #      await after.edit(name=f"{before.name}",
                ...
                if guild.me.guild_permissions.manage_webhooks:
                    await guild.ban(entry.user,
                                  reason="Xeone - Anti Guild Update")
                await after.edit(name=f"{before.name}",
                                 reason="Xeone - Recovery")
    @commands.Cog.listener()
